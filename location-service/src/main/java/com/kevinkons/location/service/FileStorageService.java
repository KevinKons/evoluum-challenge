...
import com.kevinkons.location.exception.FileNotFoundException;
...
public class FileStorageService {
    ...
    public Resource loadFileAsResource(String fileName) {
        logger.info("Inside of loadFileAsResource method of FileStorageService with parameter fileName as " + fileName);
        try {
